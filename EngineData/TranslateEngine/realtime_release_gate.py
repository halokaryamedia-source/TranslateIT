...
class RealtimeReleaseGate:
    ...
    def evaluate(self) -> RealtimeReleaseGateResult:
        final_gate = RealtimeFinalReadinessGate(model_root=self.model_root, target_pc_validated=self.target_pc_validated).evaluate()
        ...
        return RealtimeReleaseGateResult(
            ...
            blockers=blockers,
            payload={"final_gate": final_gate.to_dict(), "latency_gate": latency_gate.to_dict()},
        )
