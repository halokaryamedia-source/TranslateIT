...
from EngineData.TranslateEngine.realtime_latency_budget import RealtimeLatencyBudgetMonitor, LatencyReport
...
class RealtimeDiagnosticsAggregator:
    ...
    The UI can read this snapshot later without guessing whether the engine is
    really using fast STT/MT/TTS or silently falling back.
    """
