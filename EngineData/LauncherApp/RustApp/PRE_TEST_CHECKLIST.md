...
5. Test Settings > General.
6. Test Settings > Audio.
7. Test Settings > Translate.
8. Test Settings > Developer.
9. Reopen app once to confirm settings and local chat state are still stable.
...
- Manual testing readiness: 1% remaining.
