...
const shell = readText("EngineData/LauncherApp/RustApp/src/app/launcher/shell.ts");
...
const events = readText("EngineData/LauncherApp/RustApp/src/app/launcher/launcherEventBindings.ts");
...
const runtime = readText("EngineData/LauncherApp/RustApp/src-tauri/src/commands/runtime.rs");
...
const packageJson = readText("EngineData/LauncherApp/RustApp/package.json");
