...
const tracePath = path.join(root, "EngineData", "LauncherApp", "RustApp", "src", "app", "launcher", "userFlowTrace.ts");

const controller = fs.readFileSync(controllerPath, "utf8");
const trace = fs.readFileSync(tracePath, "utf8");
const bindings = fs.readFileSync(path.join(root, "EngineData", "LauncherApp", "RustApp", "src", "app", "launcher", "launcherEventBindings.ts"), "utf8");
