...
function helperControls(): string {
  return `<div class="settings-card-actions compact" aria-label="Helper bridge controls"><button class="mic-test-button-v22 secondary" type="button" data-helper-bridge-action="start">Start Helper</button><button class="mic-test-button-v22 secondary" type="button" data-helper-bridge-action="status">Worker Status</button><button class="mic-test-button-v22 secondary" type="button" data-helper-bridge-action="stop">Stop Helper</button><button class="mic-test-button-v22 secondary" type="button" data-helper-bridge-action="cancel">Cancel Task</button></div>`;
}
