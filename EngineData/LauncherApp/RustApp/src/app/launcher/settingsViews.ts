  ...
  return `<section class="settings-page-title"><h2>Translate</h2><p>Configure language direction, translation speed, and output behavior.</p></section>
    ...
    <article class="voice-card-v22" style="min-height:166px;padding:50px 74px;">
      <div class="voice-grid-v22">
        <section>
          <h3>Mode</h3>
          <div id="realtimeModeButton" class="radio-row-v22 ${realtimeActive ? "active" : ""}" role="button" tabindex="0" style="margin-top:34px;"><span></span><strong>Fast</strong><em>Prioritize low latency for live voice translation.</em></div>
          <div id="qualityModeButton" class="radio-row-v22 ${!realtimeActive ? "active" : ""}" role="button" tabindex="0"><span></span><strong>Quality</strong><em>Prefer better translation quality when response time is less critical.</em></div>
        </section>
        <section>
          <h3>Translate Output</h3>
          <div class="radio-row-v22 active" style="margin-top:34px;"><span></span><strong>Transcript</strong><em>Show translated text in the conversation.</em></div>
          <div class="radio-row-v22 ${voiceEnabled ? "active" : ""}"><span></span><strong>Voice</strong><em>Play translated English voice automatically.</em></div>
        </section>
      </div>
    </article>

    <section class="settings-page-title secondary"><h2>Advanced Translate Setting</h2><p>Reserved for future translation preferences.</p></section><article class="advanced-empty-v22"></article>`;
}
    ...
    <article class="audio-card-v22" style="min-height:622px;margin-top:46px;padding:52px 74px;">
      ...
      <section style="height:112px;margin-top:26px;border:1px solid var(--border-strong);border-radius:18px;background:#10141b;padding:28px;">
        ...
        <div style="position:relative;margin-top:20px;height:30px;">
          ...
          <span style="position:absolute;left:calc(${progress}% - 5px);top:8px;width:11px;height:11px;border-radius:50%;background:#d6dbe3;"></span>
          <span style="position:absolute;left:calc(${progress}% - 28px);top:-27px;display:grid;place-items:center;width:56px;height:24px;border:1px solid #4b5563;border-radius:8px;background:#11141a;color:var(--text);font-size:11.5px;font-weight:900;">${progress}%</span>
        </div>
      </section>
      ...
      <section style="height:${logHeight}px;margin-top:0;border:1px solid var(--border-strong);border-radius:18px;background:#080b11;overflow:${logOverflow};">
        ...
        <div class="developer-log-body" style="display:grid;gap:20px;padding:32px 26px;color:var(--text);font-size:12.5px;font-weight:750;">${args.logRows}</div>
      </section>
    </article>
