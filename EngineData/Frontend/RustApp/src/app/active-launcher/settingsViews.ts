...
function capturePreviewControls(): string {
  return `<div class="settings-card-actions compact" aria-label="Capture helper bridge preview controls"><button class="mic-test-button-v22 secondary" type="button" data-capture-bridge-action="start-preview">Preview Capture Start</button><button class="mic-test-button-v22 secondary" type="button" data-capture-bridge-action="stop-preview">Preview Capture Stop</button><button class="mic-test-button-v22 secondary" type="button" data-capture-bridge-action="start-dispatch">Dispatch Capture Start</button><button class="mic-test-button-v22 secondary" type="button" data-capture-bridge-action="stop-dispatch">Dispatch Capture Stop</button></div>`;
}
