...
import type { AudioStudioValidationEvidence, CaptureHelperDispatchStatus, HelperBridgeStatus, RuntimeSettings } from "../shared/types";
...
export function developerSettingsView(args: { progress: number; cpu: string; ram: string; gpu: string; gpuStatus: string; logRows: string; note: string; logsExpanded: boolean; engineGood: boolean; helperStatus: HelperBridgeStatus | null; captureHelperDispatchStatus?: CaptureHelperDispatchStatus | null; audioStudioEvidence?: AudioStudioValidationEvidence | null; }): string {
