...
import type { AudioStudioValidationEvidence, CaptureHelperDispatchStatus, CaptureTranscriptBoundaryStatus, HelperBridgeStatus, RuntimeSettings } from "../shared/types";
