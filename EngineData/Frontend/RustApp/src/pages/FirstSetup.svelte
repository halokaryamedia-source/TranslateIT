    ...
    <section class="mx-auto grid max-w-[720px] gap-6 px-8 py-9">
      ...
      {:else}
        ...
        <div class="ti-subtle-card divide-y divide-[var(--ti-border)] overflow-hidden">
          ...
          <StatusRow label="My Voice" value={myVoiceReady ? "Approved voice ready" : myVoiceReady === null ? "Checking My Voice" : "Create My Voice"} status={myVoiceReady ? "Ready" : myVoiceReady === null ? "Checking" : "Setup Needed"} tone={myVoiceReady ? "good" : myVoiceReady === null ? "neutral" : "warning"} />
