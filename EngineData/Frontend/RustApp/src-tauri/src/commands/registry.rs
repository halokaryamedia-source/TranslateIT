pub fn register<R: tauri::Runtime>(builder: tauri::Builder<R>) -> tauri::Builder<R> {
    builder.invoke_handler(tauri::generate_handler![
        ...
        crate::commands::pipeline_handoff::promote_latest_asr_payload_transcript,
        ...
        crate::commands::virtual_audio_route_runtime::dispatch_guarded_virtual_audio_route_provider,
        ...
        crate::commands::history::create_text_history_entry,
        crate::commands::history::list_history_entries,
        crate::commands::history::get_history_entry,
        crate::commands::history::save_history_entry,
        crate::commands::history::remove_saved_history_entry,
        crate::commands::history::clear_recent_history,
