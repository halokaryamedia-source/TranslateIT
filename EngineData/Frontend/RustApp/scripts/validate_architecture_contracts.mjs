...
textNotIncludes(activeIndex, "legacy", "active documentation index historical wording");
...
textNotIncludes(singleEnginePolicy, "legacy", "single active engine historical wording");
...
textNotIncludes(currentStatus, "Legacy reference", "current status removed historical reference heading");
textNotIncludes(currentStatus, "legacy reference", "current status removed historical reference wording");
...
if (capture) {
  ...
  textNotIncludes(JSON.stringify(capture), "legacy", "capture contract historical wording");
}
...
const audioStudioRust = readText("EngineData/Frontend/RustApp/src-tauri/src/commands/audio_studio.rs");
...
const audioStudioApi = readText("EngineData/Frontend/RustApp/src/app/bridge/audio/audioStudioApi.ts");
