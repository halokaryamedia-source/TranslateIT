...
const runtimePath = path.join(root, "EngineData", "Frontend", "RustApp", "src-tauri", "src", "commands", "runtime.rs");
const backendValidationPath = path.join(root, "EngineData", "Frontend", "RustApp", "src-tauri", "src", "engine", "inference", "backend_validation.rs");
