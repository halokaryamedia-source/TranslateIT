...
const files = {
  ...
  runtimeApi: path.join(packageRoot, "src", "app", "bridge", "runtime", "runtimeApi.ts"),
  developerBinding: path.join(packageRoot, "src", "app", "launcher", "developerHelperBridgeBinding.ts"),
  buttonContract: path.join(packageRoot, "src", "app", "active-launcher", "buttonActionContract.ts"),
};
