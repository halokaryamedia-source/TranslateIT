...
HF_HOME = ROOT / "UserData" / "CacheData" / "model_cache" / "HuggingFaceHome"
...
ASR_PRIMARY = ROOT / "EngineData" / "Backend" / "RuntimeAssets" / "ASR" / "ModelData" / "faster-whisper-large-v3-turbo"
ASR_BACKUP = ROOT / "EngineData" / "Backend" / "RuntimeAssets" / "ASR" / "ModelData" / "faster-whisper-medium"
TRANSLATION_PRIMARY = ROOT / "EngineData" / "Backend" / "RuntimeAssets" / "Translation" / "ModelData" / "nllb-200-distilled-600M"
TRANSLATION_FALLBACK = ROOT / "EngineData" / "Backend" / "RuntimeAssets" / "Translation" / "ModelData" / "marianmt-id-en"
