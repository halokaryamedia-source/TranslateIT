...
const bindingsPath = path.join(root, "EngineData", "Frontend", "RustApp", "src", "app", "launcher", "launcherEventBindings.ts");
const shellPath = path.join(root, "EngineData", "Frontend", "RustApp", "src", "app", "launcher", "shell.ts");
...
const styles = read(path.join(root, "EngineData", "Frontend", "RustApp", "src", "styles.css"));
