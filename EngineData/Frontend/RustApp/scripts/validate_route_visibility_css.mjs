...
const controller = fs.readFileSync(path.join(root, "EngineData", "Frontend", "RustApp", "src", "app", "launcher", "launcherController.ts"), "utf8");
const styles = fs.readFileSync(path.join(root, "EngineData", "Frontend", "RustApp", "src", "styles.css"), "utf8");
