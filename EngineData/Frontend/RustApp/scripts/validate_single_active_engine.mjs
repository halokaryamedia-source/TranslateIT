...
const forbiddenPaths = [
  "EngineData/Backend/RuntimeAssets/ASR",
  "EngineData/Backend/RuntimeAssets/Translation",
  "EngineData/Backend/LocalWorker",
  "EngineData/Backend/RuntimeAssets",
  "EngineData/Backend/LocalWorker/WorkerRuntime",
  "EngineData/Frontend/launcher.py",
  "EngineData/Frontend/app.py",
  "EngineData/Frontend/main.py",
  "EngineData/Frontend/latency_meter.py",
  "EngineData/Frontend/session_reporting.py",
  "DevelopingData/Tooling/run_translateit_historical_tts.bat",
