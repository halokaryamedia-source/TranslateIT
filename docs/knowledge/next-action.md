...
- Code Health now executes Python compile + E4/E7/E9/full-F static checks + contract/unit tests, Linux Rust compiler/dead-code + Clippy correctness + unit tests, and hosted Windows Rust compiler/dead-code + unit tests; production npm dependencies are audited in CI.
