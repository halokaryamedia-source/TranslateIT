...
7. Installer-free smoke baseline (2026-08-23): CUDA BF16 smoke green (ASR preload, both MiLMMT directions, persistent lifecycle). Evidence: `UserData/LogData/RustAppValidation/latest_worker_smoke_result.json`.
