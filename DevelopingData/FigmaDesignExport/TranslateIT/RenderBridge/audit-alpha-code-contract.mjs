...
const checks = [
  ...
  ['plugin polished alpha renderer', plugin, 'translateit-alpha-professional-figma-renderer'],
  ['plugin visual polish level', plugin, 'visualPolishLevel'],
  ['plugin design theme system', plugin, 'function theme(plan)'],
