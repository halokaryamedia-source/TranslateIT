...
if(health.visualModel!=='screenshot-first-html-assisted-visual-model')throw new Error('Wrong visualModel: '+(health.visualModel||'missing'));
...
if(health.visualComparison!=='source-vs-clone-preview-sampling')throw new Error('Wrong visualComparison: '+(health.visualComparison||'missing'));
