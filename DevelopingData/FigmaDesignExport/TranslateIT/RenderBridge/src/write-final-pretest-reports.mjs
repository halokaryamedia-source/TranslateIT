...
async function main() {
  ...
  console.log(JSON.stringify({ status: 'written', healthStatus: health.status, healthNextAction: health.nextAction, assetStatus: assets.status, healthPath, assetPath }, null, 2));
}
