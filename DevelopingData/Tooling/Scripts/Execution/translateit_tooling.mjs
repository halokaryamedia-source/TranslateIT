...
function summarizeReadiness() {
  ...
  const payload = { schema: "translateit.readiness_summary.v2", created_at: new Date().toISOString(), client_ready: blockers.length === 0, blockers, note: "Client-ready remains false until all local build and manual runtime evidence passes." };
