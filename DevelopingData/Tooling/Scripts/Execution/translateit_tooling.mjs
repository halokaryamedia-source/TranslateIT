...
const APP_PACKAGE = join(ROOT, "EngineData", "Frontend", "RustApp");
const TARGET_APP_PACKAGE = join(ROOT, "EngineData", "Frontend", "App");
...
function validateStructure() {
  ...
  const retired = [
    "DeveloperData", "DevelopingData/DocumentationData", "DevelopingData/Documentation/Reports",
    "DevelopingData/Documentation", "DevelopingData/Tooling", "DevelopingData/Samples",
    "TranslateIT.vbs", "TranslateIT.cmd", "Launcher", "EngineData/Backend/RuntimeAssets", "EngineData/Frontend/Workers",
    "EngineData/TranscriptEngine", "EngineData/TranslateEngine", "EngineData/Backend/LocalWorker",
  ...
  const allowedEnginePython = new Set([
    ...
    "EngineData/Frontend/RustApp/scripts/prepare_local_models.py",
    "EngineData/Frontend/RustApp/scripts/validate_local_models.py",
  ]);
